    ...
    <div className="flex items-center justify-between w-full">
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          className="flex items-center gap-2 px-3 py-1.5 rounded-none bg-accent text-white border border-accent transition-all text-[9px] font-bold uppercase tracking-widest hover:bg-white hover:text-accent shadow-lg h-8"
