  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 flex flex-col w-full">
      ...
      <div className="bg-accent text-white py-1 px-6 lg:px-12 hidden md:block border-b border-white/10">
        <div className="max-w-7xl mx-auto flex justify-between items-center text-[9px] font-bold uppercase tracking-wider">
          ...
          <div className="flex items-center gap-6">
            <div className="flex items-center gap-2 group cursor-pointer hover:text-white/80 transition-colors">
              ...
              <Search className="w-2.5 h-2.5 text-white/80 group-hover:text-white" />
            </div>
            <div className="flex items-center gap-2 cursor-pointer hover:text-white/80 transition-colors">
              <Globe className="w-2.5 h-2.5 text-white/80" />
              <span>English</span>
      ...
      {/* Tier 2: Middle Contact Hub - Compacted */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-3 items-center">
          ...
          <div className="flex flex-col gap-0">
            <div className="flex items-center gap-2 text-[7px] text-muted-foreground font-medium uppercase tracking-widest">
              ...
              <span>Elite Towers, Ohio St, Dar es Salaam.</span>
            </div>
            <a href="tel:+255222123456" className="text-sm font-headline font-bold text-accent hover:opacity-80 transition-opacity">
              +255 (0) 222 123 456
            </a>
          </div>

          {/* Center: Typographic Mark */}
          <Link href="/" className="flex flex-col items-center justify-center group">
            <span className="text-xl lg:text-2xl font-headline font-bold text-accent leading-none tracking-tight">G&apos;ADROIT</span>
            <span className="text-[6px] font-bold text-primary tracking-[0.5em] uppercase mt-0.5">Attorneys</span>
          </Link>
          ...
          <div className="flex flex-col items-end gap-0">
            ...
            <a href="mailto:consult@gadroit.com" className="text-sm font-headline font-bold text-accent hover:opacity-80 transition-opacity">
              consult@gadroit.com
            </a>
          </div>
        </div>
      ...
      <div className={cn(
        ...
        isScrolled ? "fixed top-0 left-0 right-0 shadow-xl py-0" : "relative py-0"
      )}>
        <nav className="max-w-7xl mx-auto flex items-center justify-between h-10 md:h-12">
          <div className="md:hidden py-1.5 w-full">
