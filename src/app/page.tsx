...
export default function Home() {
  ...
  return (
    <div className="w-full">
            ...
            <div className="lg:col-span-7 space-y-6 animate-in fade-in slide-in-from-left-8 duration-1000">
              <div className="space-y-4">
                <div className="flex items-center gap-4">
                  ...
                  <span className="text-[9px] uppercase tracking-[0.5em] font-bold text-accent">Strategic Regional Partner</span>
                </div>
                ...
                <p className="text-base md:text-lg text-primary-foreground/70 max-w-xl font-light leading-relaxed">
                  G'Adroit Attorneys provides elite legal architecture for high-stakes cross-border investment and complex dispute resolution in Tanzania and across East Africa.
                </p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4 pt-2">
                <Button asChild className="w-full sm:w-auto bg-accent text-accent-foreground hover:bg-white hover:text-primary rounded-none px-8 h-12 text-[10px] font-bold tracking-widest transition-all group">
                  <Link href="/contact" className="flex items-center gap-2">
                    REQUEST CONFIDENTIAL CONSULTATION <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
                  </Link>
                </Button>
      ...
      {/* Sectoral Command - Plan Update */}
      <SectoralCommand />

      {/* Investor Friction - Investor Challenges in East Africa */}
      <section className="py-12 md:py-16 bg-secondary/20 overflow-hidden border-b">
        <div className="container mx-auto px-6 lg:px-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            <div className="space-y-6 lg:sticky lg:top-32">
              <div className="space-y-3">
                <span className="text-accent font-bold text-[10px] tracking-[0.4em] uppercase">Investor Challenges</span>
                <h2 className="text-3xl md:text-5xl font-headline font-bold text-primary leading-tight">Navigating Regional <br />Friction.</h2>
                <p className="text-base text-muted-foreground font-light leading-relaxed max-w-lg">
                  We provide the legal lubrication required for institutional investors to navigate the unique challenges of the East African market.
                </p>
              </div>
            ...
            <div className="w-full bg-white/50 backdrop-blur-sm p-4 md:p-8 border border-primary/5 shadow-inner">
              <Accordion type="single" collapsible className="w-full">
                {[
                  { q: 'Market Entry & TIC Structuring', a: 'Precision advisory on TIC vs EPZ vehicles to optimize capital importation and tax incentives from day one.' },
                  { q: 'Local Content & Regulatory Approvals', a: 'Managing complex ownership requirements and multi-agency licensing to ensure seamless operational continuity.' },
                  { q: 'HR & Labor Compliance', a: 'Balancing international corporate standards with strict local labor laws and work permit protocols.' },
                  { q: 'Asset Protection & Dispute Recourse', a: 'Drafting ironclad arbitration clauses and utilizing BIT protections to shield capital from judicial volatility.' },
                ].map((item, idx) => (
      ...
      {/* Attorneys & Institutional Narrative */}
      <AttorneysSection />
      <FirmNarrative />
        ...
        <div className="container mx-auto px-6 lg:px-12 text-center relative z-10">
          <div className="max-w-4xl mx-auto space-y-6 md:space-y-8">
            ...
            <p className="text-base md:text-xl text-primary-foreground/60 font-light leading-relaxed max-w-2xl mx-auto">
              Providing the legal authority and international standard expertise required for significant institutional investment in Tanzania.
            </p>
            <div className="pt-2">
