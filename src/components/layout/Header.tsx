...
const Header = () => {
  ...
  return (
    <header className="absolute top-0 left-0 right-0 z-50 flex flex-col w-full">
      ...
      <div className="bg-accent text-white py-1.5 px-6 lg:px-12 hidden md:block border-b border-white/10">
      ...
      <div className="bg-white py-3 px-6 lg:px-12 hidden md:block border-b border-secondary/50 shadow-sm">
        <div className="max-w-7xl mx-auto grid grid-cols-3 items-center">
          {/* Left: Address & Phone */}
          <div className="flex flex-col gap-0.5">
            <div className="flex items-center gap-2 text-[8px] text-muted-foreground font-medium uppercase tracking-widest">
              <MapPin className="w-2.5 h-2.5 text-accent" />
              <span>Elite Towers, Ohio St, Dar es Salaam.</span>
            </div>
            <a href="tel:+255222123456" className="text-base font-headline font-bold text-accent hover:opacity-80 transition-opacity">
              +255 (0) 222 123 456
            </a>
          </div>
          ...
          <Link href="/" className="flex flex-col items-center justify-center group">
            <span className="text-2xl lg:text-3xl font-headline font-bold text-accent leading-none tracking-tight">G&apos;ADROIT</span>
            <span className="text-[7px] font-bold text-primary tracking-[0.5em] uppercase mt-1">Attorneys</span>
          </Link>
          ...
          <div className="flex flex-col items-end gap-0.5">
            ...
            <a href="mailto:consult@gadroit.com" className="text-base font-headline font-bold text-accent hover:opacity-80 transition-opacity">
              consult@gadroit.com
            </a>
          </div>
        </div>
      ...
      <div className={cn(
        ...
        isScrolled ? "fixed top-0 left-0 right-0 shadow-xl py-0.5" : "relative py-0"
      )}>
